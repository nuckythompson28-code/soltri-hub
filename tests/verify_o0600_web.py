...
with sync_playwright() as p:
    ...
    page.locator('#nav a[href="#O0600"]').click()
    ...
    context.set_offline(True);page.goto(base+'o0600.html');expect(page.locator('#copy-source')).to_be_enabled();context.set_offline(False)
    ...
    mobile.goto(base+'o0600.html');expect(mobile.locator('#copy-source')).to_be_enabled()
    for section in ['setup','O0600','O9050','vars','validation','overview']:
